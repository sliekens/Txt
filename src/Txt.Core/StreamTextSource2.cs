...
namespace Txt.Core
{
    public class StreamTextSource2 : TextSource2
    {
        private readonly BinaryReader reader;

        private bool disposed;

        public StreamTextSource2([NotNull] Stream input, int capacity = 2048)
            : base(capacity)
        {
            if (input == null)
            {
        ...
        public StreamTextSource2([NotNull] Stream input, [NotNull] Encoding encoding, int capacity = 2048)
            : base(capacity)
        {
            if (input == null)
            {
