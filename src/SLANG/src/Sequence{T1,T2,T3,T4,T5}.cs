// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Sequence{T1,T2,T3,T4,T5}.cs" company="Steven Liekens">
//   The MIT License (MIT)
// </copyright>
// <summary>
//   Represents a sequence of five elements.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace SLANG
{
    ...
    public class Sequence<T1, T2, T3, T4, T5> : Element
        where T1 : Element
        where T2 : Element
        where T3 : Element
        where T4 : Element
        where T5 : Element
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="Sequence{T1,T2,T3,T4,T5}"/> class with a specified sequence of elements.</summary>
