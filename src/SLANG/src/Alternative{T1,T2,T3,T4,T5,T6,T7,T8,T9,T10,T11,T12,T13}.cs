namespace SLANG
{
    ...
    /// <summary>Represents a choice of thirteen alternative elements.</summary>
    ...
    public class Alternative<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> : Element
        where T1 : Element
        where T2 : Element
        where T3 : Element
        where T4 : Element
        ...
        where T13 : Element
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="Alternative{T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,T13}" /> class with a
            ...
            : base(element.Data, context)
        {
            switch (alternative)
            {
                ...
                case 13:
                    ...
                    break;
                default:
                    throw new ArgumentOutOfRangeException("alternative", alternative, "Precondition: 1 <= alternative <= 13");
            }
