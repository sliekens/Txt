namespace SLANG
{
    ...
    public abstract class SequenceLexer<TSequence, T1, T2, T3, T4, T5, T6, T7> : Lexer<TSequence>
        ...
        where T7 : Element
    {
        /// <summary>Initializes a new instance of the <see cref="SequenceLexer{TSequence,T1,T2,T3,T4,T5,T6,T7}"/> class for an unnamed element.</summary>
        ...
        {
            return (TSequence)Activator.CreateInstance(typeof(TSequence), element1, element2, element3, element4, element5, element6, element7, context);
        }
