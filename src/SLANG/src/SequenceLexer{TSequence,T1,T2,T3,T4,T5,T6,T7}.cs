namespace SLANG
{
    ...
    /// <summary>Provides the base class for lexers whose lexer rule is a sequence of seven elements.</summary>
    ...
    public abstract class SequenceLexer<TSequence, T1, T2, T3, T4, T5, T6, T7> : Lexer<TSequence>
        where TSequence : Sequence<T1, T2, T3, T4, T5, T6, T7>
        where T1 : Element
        where T2 : Element
        where T3 : Element
        where T4 : Element
        ...
        where T7 : Element
    {
        /// <summary>Initializes a new instance of the <see cref="SequenceLexer{TSequence,T1,T2,T3,T4,T5,T6,T7}"/> class for a specified rule.</summary>
