namespace SLANG
{
    ...
    /// <summary>Represents a choice of eleven alternative elements.</summary>
    ...
    public class Alternative<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : Element
        where T1 : Element
        where T2 : Element
        where T3 : Element
        where T4 : Element
            ...
            : base(element)
        {
            switch (alternative)
            {
                ...
                case 11:
                    ...
                    break;
                default:
                    throw new ArgumentOutOfRangeException("alternative", alternative, "Precondition: 1 <= alternative <= 11");
            }
