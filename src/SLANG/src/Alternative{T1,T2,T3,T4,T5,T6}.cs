// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Alternative{T1,T2,T3,T4,T5,T6}.cs" company="Steven Liekens">
//   The MIT License (MIT)
// </copyright>
// <summary>
//   Represents a choice of six alternative elements.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace SLANG
{
    ...
    /// <summary>Represents a choice of six alternative elements.</summary>
    ...
    public class Alternative<T1, T2, T3, T4, T5, T6> : Element
        where T1 : Element
        where T2 : Element
        where T3 : Element
        where T4 : Element
        ...
        where T6 : Element
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="Alternative{T1,T2,T3,T4,T5,T6}"/> class with a specified alternative.</summary>
            ...
            : base(element.Data, context)
        {
            switch (alternative)
            {
                ...
                case 6:
                    ...
                    break;
                default:
                    throw new ArgumentOutOfRangeException("alternative", alternative, "Precondition: 1 <= alternative <= 6");
            }
