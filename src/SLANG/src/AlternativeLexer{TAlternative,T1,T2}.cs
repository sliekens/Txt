// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AlternativeLexer{TAlternative,T1,T2}.cs" company="Steven Liekens">
//   The MIT License (MIT)
// </copyright>
// <summary>
//   Provides the base class for lexers whose lexer rule has two alternatives.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace SLANG
{
    ...
    /// <summary>Provides the base class for lexers whose lexer rule has two alternatives.</summary>
    ...
    public abstract class AlternativeLexer<TAlternative, T1, T2> : Lexer<TAlternative>
        where TAlternative : Alternative<T1, T2>
        where T1 : Element
        where T2 : Element
    {
