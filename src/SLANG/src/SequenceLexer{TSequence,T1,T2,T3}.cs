namespace SLANG
{
    ...
    /// <summary>Provides the base class for lexers whose lexer rule is a sequence of three elements.</summary>
    ...
    public abstract class SequenceLexer<TSequence, T1, T2, T3> : Lexer<TSequence>
        where TSequence : Sequence<T1, T2, T3>
        where T1 : Element
        where T2 : Element
        where T3 : Element
    {
        /// <summary>Initializes a new instance of the <see cref="SequenceLexer{TSequence,T1,T2,T3}"/> class for an unnamed element.</summary>
        protected SequenceLexer()
        {
        }

        /// <summary>Initializes a new instance of the <see cref="SequenceLexer{TSequence,T1,T2,T3}"/> class for a specified rule.</summary>
        ...
        {
            return (TSequence)Activator.CreateInstance(typeof(TSequence), element1, element2, element3, context);
        }
