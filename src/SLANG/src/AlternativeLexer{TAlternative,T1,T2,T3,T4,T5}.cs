namespace SLANG
{
    ...
    /// <summary>Provides the base class for lexers whose lexer rule has five alternatives.</summary>
    ...
    public abstract class AlternativeLexer<TAlternative, T1, T2, T3, T4, T5> : Lexer<TAlternative>
        where TAlternative : Alternative<T1, T2, T3, T4, T5>
        where T1 : Element
        where T2 : Element
        where T3 : Element
        where T4 : Element
        where T5 : Element
    {
        /// <summary>Initializes a new instance of the <see cref="AlternativeLexer{TAlternative,T1,T2,T3,T4,T5}"/> class for an unnamed element.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="AlternativeLexer{TAlternative,T1,T2,T3,T4,T5}"/> class for a specified rule.</summary>
        /// <param name="serviceLocator">The object that retrieves instances of <see cref="ILexer{TElement}"/> by type and optional rule name.</param>
