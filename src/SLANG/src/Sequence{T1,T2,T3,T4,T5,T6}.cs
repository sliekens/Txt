// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Sequence{T1,T2,T3,T4,T5,T6}.cs" company="Steven Liekens">
//   The MIT License (MIT)
// </copyright>
// <summary>
//   Represents a sequence of six elements.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace SLANG
{
    ...
    /// <summary>Represents a sequence of six elements.</summary>
    ...
    public class Sequence<T1, T2, T3, T4, T5, T6> : Element
        where T1 : Element
        where T2 : Element
        where T3 : Element
        where T4 : Element
        ...
        where T6 : Element
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="Sequence{T1,T2,T3,T4,T5,T6}"/> class with a specified sequence of elements.</summary>
        ...
        public Sequence(
            ...
            : base(
                string.Concat(element1.Data, element2.Data, element3.Data, element4.Data, element5.Data, element6.Data), 
                context)
        {
