namespace SLANG
{
    ...
    /// <summary>Provides the base class for lexers whose lexer rule has eight alternatives.</summary>
    ...
    public abstract class AlternativeLexer<TAlternative, T1, T2, T3, T4, T5, T6, T7, T8> : Lexer<TAlternative>
        where TAlternative : Alternative<T1, T2, T3, T4, T5, T6, T7, T8>
        where T1 : Element
        where T2 : Element
        where T3 : Element
        where T4 : Element
