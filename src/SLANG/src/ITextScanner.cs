...
namespace SLANG
{
    ...
    public interface ITextScanner : ITextContext, IDisposable
    {
        ...
        /// <summary>Compares the given character to the next available character. The comparison is case-insensitive. If there is a match, the character is consumed.</summary>
        /// <param name="c">The character to compare to the next available character.</param>
