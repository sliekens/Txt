// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Sequence{T1,T2,T3,T4,T5,T6,T7,T8,T9}.cs" company="Steven Liekens">
//   The MIT License (MIT)
// </copyright>
// <summary>
//   Represents a sequence of nine elements.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace Text.Scanning
{
    ...
    /// <summary>Represents a sequence of nine elements.</summary>
    ...
    public class Sequence<T1, T2, T3, T4, T5, T6, T7, T8, T9> : Element
        where T1 : Element
        where T2 : Element
        where T3 : Element
        where T4 : Element
        ...
        where T9 : Element
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="Sequence{T1,T2,T3,T4,T5,T6,T7,T8,T9}"/> class with a specified sequence of elements.</summary>
