namespace Text.Scanning.Core
{
    ...
    public class WhiteSpace : Element
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Text.Scanning.Core.WhiteSpace" /> class with a specified white space
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Text.Scanning.Core.WhiteSpace" /> class with a specified character
        /// and context.
        /// </summary>
