// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Alternative{T1,T2,T3,T4,T5,T6,T7}.cs" company="Steven Liekens">
//   The MIT License (MIT)
// </copyright>
// <summary>
//   Represents a choice of seven alternative elements.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace Text.Scanning
{
    ...
    /// <summary>Represents a choice of seven alternative elements.</summary>
    ...
    public class Alternative<T1, T2, T3, T4, T5, T6, T7> : Element
        where T1 : Element
        where T2 : Element
        where T3 : Element
        where T4 : Element
        ...
        where T7 : Element
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="Alternative{T1,T2,T3,T4,T5,T6,T7}"/> class with a specified alternative.</summary>
